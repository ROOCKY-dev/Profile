...
export default function Navbar() {
  ...
  const statusColor =
    SITE.status.current === "WORKING"
      ? "bg-amber-400"
      : SITE.status.current === "AVAILABLE"
      ? "bg-emerald-400"
      : SITE.status.current === "STUDYING"
      ? "bg-blue-400"
      : "bg-zinc-500";
        ...
        <div className="w-full max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 h-[72px] flex items-center justify-between">
          ...
          >
            ...
            <span className="font-mono text-sm font-medium tracking-tight text-[var(--text-primary)]">
              roocky<span className="text-[var(--text-tertiary)]">.dev</span>
            </span>
          </Link>
