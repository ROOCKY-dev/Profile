...
export default function LandingSection({ status, focusLevel, errorCount, voiceLevel, customColor }: LandingSectionProps) {
  ...
  return (
    <section id="home" className="h-screen w-full flex flex-col md:flex-row items-center justify-between relative bg-transparent snap-start overflow-hidden pt-16 md:pt-0">

      {/* Left Column: Status */}
      <div className="w-full md:w-1/4 h-auto md:h-full border-b md:border-b-0 md:border-r border-white/5 p-6 md:p-8 flex flex-row md:flex-col justify-between md:justify-center items-center md:items-start bg-black/30 backdrop-blur-sm z-10 pointer-events-auto">
        ...
        <div className="mb-0 md:mb-8 flex flex-col items-center md:items-start">
            <div className="text-3xl md:text-5xl font-bold text-white tracking-tighter mb-2 min-h-[32px] md:min-h-[48px]">
      ...
      {/* Right Column: Nav - Hidden on Mobile since we have Navbar */}
      <div className="hidden md:flex w-1/4 h-full border-l border-white/5 p-8 flex-col justify-center items-end bg-black/30 backdrop-blur-sm z-10 pointer-events-auto">
