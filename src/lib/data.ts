import { TimelineEventData, TechItem, Project, AboutMeData, LandingContent } from './types';
...
export const ABOUT_ME: AboutMeData = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: 'I am currently deep-diving into Discrete Structures and Computer Organization while expanding my portfolio in game development. My goal is to transition into the European or Chinese tech landscapes for the 2026-2027 academic year, bringing a global perspective to software engineering.'
    }
  ]
};
